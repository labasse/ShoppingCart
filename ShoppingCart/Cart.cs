...
namespace ShoppingCart
{
    ...
    public class Cart
    {
        ...
        /// <summary>
        /// Gets list of the cart articles.
        /// </summary>
        /// <example>
        ...
        /// <summary>
        /// Adds an article to the cart with the given quantity and price.
        /// </summary>
        ...
        /// <summary>
        /// Decreases the quantity of the article with the given product name. 
        /// </summary>
        ...
        /// <summary>
        /// Gets the total price for all the shopping cart
        /// </summary>
